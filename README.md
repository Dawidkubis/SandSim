...
## Problémy
+ Neoptimalizováno; známé důvody jsou: 1000x800 Array když jsou potřeba pouze 100x80 polí, žádné invokované metody (pouze lineární kód), žádné využití objektů, nemodulární design, řešením by byl třetí celkový přepis (již jsem to několikrát zkoušel opravit a pokaždé se něco rozbilo)
